...
describe('Register', () => {
  ...
  it('onRegister method should be triggered', () => {
    ...
    wrapper
      .find('Input#email')
      .simulate('change', { target: { value: 'a@valid.email' } });
    wrapper
    ...
    wrapper
      .find('Input#password')
      .simulate('change', { target: { value: 'AValidPassw0rd' } });
    wrapper
      .find('Input#passwordConfirm')
      .simulate('change', { target: { value: 'AValidPassw0rd' } });
  ...
  it('onRegister method should not be triggered - invalid email', () => {
    ...
    wrapper
      .find('Input#email')
      .simulate('change', { target: { value: 'ThisIsNotAnEmail' } });
    wrapper
      .find('Input#firstName')
      .simulate('change', { target: { value: 'First' } });
    wrapper
  ...
  it('onRegister method should not be triggered - mismatched passwords', () => {
    ...
    wrapper
      .find('Input#passwordConfirm')
      .simulate('change', { target: { value: 'AValidPassw1rd' } });
